    ...
    private class SensorListener implements SensorEventListener
    {
        ...
        public void onSensorChanged(SensorEvent event)
        {
            ...
            if((this.accelTime != 0 || !this.hasAccel) && (this.gyroTime != 0 || !this.hasGyro) && (this.quatTime != 0 || !this.hasQuat))
            {
                ...
                long timeInMillis = time_delta_millis + event.timestamp/1000000;

                int secs = (int)(timeInMillis / 1000L);
                int nsecs = (int)(timeInMillis % 1000L) * 1000000+(int)(event.timestamp/1000000);
                imu_time=new Time(secs, nsecs);
                this.imu.getHeader().setStamp(imu_time);
                this.imu.getHeader().setFrameId(nodeName+"/imu");// TODO Make parameter
//                Log.d("imu_time"," "+imu_time);
//                Log.d("imu_time","nsec "+nsecs);
